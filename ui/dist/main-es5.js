(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GenericService = /** @class */ (function () {
                ...
                GenericService.prototype.getItems = function (entName) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/json');
                    headers.append("access-control-allow-methods", "POST, PUT, DELETE, GET, OPTIONS");
                ...
                GenericService.prototype.getItemsSql = function (ent, id) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/json');
                    headers.append("access-control-allow-methods", "POST, PUT, DELETE, GET, OPTIONS");
                    var obj = new ApiSend();
                    obj.p_entity = ent;
                ...
                GenericService.prototype.updateItem = function (ent, id, fldName, data) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/json');
                ...
                GenericService.prototype.deleteItem = function (ent, id, fldName, data) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/json');
                    var headers2 = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/json');
                    headers.append("access-control-allow-methods", "POST, PUT, DELETE, GET, OPTIONS");
                    var options = {
                ...
                GenericService.prototype.updateItem2 = function (ent, id, fldName, data) {
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Content-Type', 'application/json');
                    headers.append("access-control-allow-methods", "POST, PUT, DELETE, GET, OPTIONS");
                    var obj = new ApiSend();
                    obj.p_entity = ent;
            ...
            var ApiSend = /** @class */ (function () {
                function ApiSend() {
                }
                return ApiSend;
            }());
            var ApiSendSave = /** @class */ (function () {
                function ApiSendSave() {
                }
                return ApiSendSave;
            }());
            /***/ 
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TableFunctionsService = /** @class */ (function () {
                function TableFunctionsService() {
                ...
                TableFunctionsService.prototype.DoChangeColumns = function (entName) {
                    var ret = new retObject();
                    var obj = this.retVal.find(function (obj) { return obj["name"] == entName; });
                    ret.columns = obj.columns;
                    ret.keyField = obj.entKeyField;
                    return ret;
                };
                return TableFunctionsService;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Table1Component = /** @class */ (function () {
                ...
                function Table1Component(genericService, tableFunctions, toastrService) {
                ...
                Table1Component.prototype.LoadItems = function (entName) {
                    var _this = this;
                    this.genericService.getItems(entName).subscribe(function (data) {
                        // this.data = data.result;
                        _this.data = data;
                        _this.currentItemFieldSequence = _this.data[0];
                        _this.currentItem = _this.data[0];
                        _this.currentItemCloneFields = Object.assign({}, _this.currentItem);
                        var currItemKeys = Object.keys(_this.currentItem);
                        _this.currentItemKeys = [];
                        for (var _i = 0, currItemKeys_1 = currItemKeys; _i < currItemKeys_1.length; _i++) {
                            var prop = currItemKeys_1[_i];
                            _this.currentItemKeys.push(prop);
                        }
                        _this.doAdd();
                    }),
                        function (err) {
                ...
                Table1Component.prototype.onChange = function (name) {
                    this.table.apiEvent({
                        type: ngx_easy_table__WEBPACK_IMPORTED_MODULE_4__["API"].onGlobalSearch, value: name,
                    });
                };
                Table1Component.prototype.onSelect = function (productId) {
                ...
                Table1Component.prototype.eventEmitted = function ($event) {
                    ...
                    if ($event.value.row) {
                        ...
                        var currItemKeys = Object.keys(this.currentItem);
                        this.currentItemKeys = [];
                        for (var _i = 0, currItemKeys_2 = currItemKeys; _i < currItemKeys_2.length; _i++) {
                            var prop = currItemKeys_2[_i];
                ...
                Table1Component.prototype.trackByFn = function (index, item) {
                    return index;
                };
                Table1Component.prototype.doSave = function (entName, id) {
                    var test = this.currentItem;
                    this.UpdateItem(entName, id, 'id', test);
                };
                Table1Component.prototype.doDelete = function (index) {
                    var testIndex = this.currentItemIndex;
                    var test = this.currentItem;
                    var ent = this.entity;
                    var curId = this.currentItem[this.entKeyField];
                    this.deleteItem(ent, curId, this.entKeyField, test, index);
                    this.toastrService.error('Have a nice day.', "Item Deleted.", { timeOut: 3000 });
                };
                Table1Component.prototype.doAdd = function () {
                    var currItemKeys = Object.keys(this.currentItem);
                    //this.currentItem = null;
                    this.currentItemKeys = [];
                    for (var _i = 0, currItemKeys_3 = currItemKeys; _i < currItemKeys_3.length; _i++) {
                        var prop = currItemKeys_3[_i];
                        this.currentItemKeys.push(prop);
                    }
                    this.currentItem = new Object();
                    this.currentItem[this.entKeyField] = "0";
                };
                Table1Component.prototype.UpdateItem = function (ent, id, fldName, dataEdit) {
                    var _this = this;
                    ent = this.entity;
                    this.genericService.updateItem(ent, id, fldName, dataEdit).subscribe(function (data) {
                        var test = data;
                        //this.currentDataArray = test;
                        _this.currentItemUpdate = test;
                        var curId = _this.currentItemUpdate[_this.entKeyField];
                        //this.currentRowData = data;
                        var curRowItem = _this.data[_this.currentItemIndex];
                        if (id == "0") {
                            _this.addRow(test);
                            _this.toastrService.info('Have a nice day.', "Item Added.", { timeOut: 3000 });
                        }
                        else {
                            var obj = _this.data.find(function (obj) { return obj[_this.entKeyField] == curId; });
                            var objIndex = _this.data.indexOf(obj);
                            _this.setTableItem(objIndex);
                            _this.toastrService.success('Have a nice day.', "Item Saved.", { timeOut: 3000 });
                        }
                    }),
                        function (err) {
                            console.log(err);
                ...
                Table1Component.prototype.deleteItem = function (ent, id, fldName, data, index) {
                    var _this = this;
                    ent = this.entity;
                    this.genericService.deleteItem(ent, id, fldName, data).subscribe(function (data) {
                        var test = data;
                        _this.remove(_this.currentItemIndex);
                    }),
                        function (err) {
                            console.log(err);
                        };
                };
                Table1Component.prototype.setTableItem = function (editIndex) {
                    var _this = this;
                    this.data = this.data.map(function (obj, index) {
                        if (index === editIndex) {
                            //  obj = updatedItem;
                            return _this.currentItemUpdate;
                        }
                        return obj;
                    }).slice();
                    // this.currentItemIndex =-1
                };
                Table1Component.prototype.addRow = function (addedItem) {
                    this.data = this.data.concat([
                        addedItem,
                    ]);
                };
                Table1Component.prototype.remove = function (rowIndex) {
                    this.data = this.data.filter(function (_v, k) { return k !== rowIndex; }).slice();
                };
                return Table1Component;
            }());
            Table1Component.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EntityVariablesItems = /** @class */ (function () {
                function EntityVariablesItems() {
                    this.entityGridColumns = [];
                }
                return EntityVariablesItems;
            }());
            var EntityVariables = {
                entityListItems: [
