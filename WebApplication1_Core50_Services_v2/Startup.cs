...
namespace WebApplication1_Core50
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
           ...
           // services.AddScoped<ApplicationDbContext>(provider => provider.GetService<ApplicationDbContext>());
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "WebApplication1_Core50", Version = "v1" });
            });
        }
     ...
     options => options.AllowAnyOrigin().AllowAnyMethod().AllowAnyHeader()
            ...
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "WebApplication1_Core50 v1"));
            }
